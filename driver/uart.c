...
volatile char  read_tag_id[16]={"00000000000000"};
volatile uint8_t  tag_reader_flag;
...
void serial_analitic(char data){
  ...
  switch(data) {
    ...
    default : 
     if (uart_rx_idx<15){
       ...
       if(uart_rx_idx>=6 && uart_rx_idx<=13){ 
         read_tag_id[uart_rx_idx-6]=data;
       }
       uart_rx_idx++;
     }
  }
